...
void main() {
  assert(() {
    if (fb.apps.isEmpty) {
      fb.initializeApp(
          apiKey: "AIzaSyA9MCbPS7TMhKZtwOooYquP1T0dhHztzAE",
          authDomain: "vhaconsultancy.firebaseapp.com",
          databaseURL: "https://vhaconsultancy.firebaseio.com",
          projectId: "vhaconsultancy",
          storageBucket: "vhaconsultancy.appspot.com",
          messagingSenderId: "371517175983",
